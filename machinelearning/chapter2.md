...
모델이 실제 데이터를 바르게 표현했는지 혹은 얼마나 예측이 정확한지는 손실함수<sup>loss function</sup>으로 평가할 수 있습니다. 앞선 선형회귀를 예를 들면 직선에서 데이터가 얼마나 떨어져 있는지 계산하는 함수가 손실함수 입니다.

손실함수는 값이 작을 수록 정확하게 학습이 되었다고 볼 수 있습니다. 이때 손실함수로 얻은 결괏값을 보통 에러라고 부릅니다.